...
x3 = np.random.random(size=200) * 30 - 5
y3 = np.random.random(size=200) * 30 - 5
...
p2.scatter(x2, y2, size=5, color='blue', alpha=0.5)

p3 = figure(x_range=xr, y_range=yr, tools=TOOLS, plot_width=300, plot_height=300)
p3.scatter(x2, y2, size=2, color='green', alpha=0.5)
...
p4.circle(x, y, fill_color='red', line_color=None, radius=radii, fill_alpha=0.5, tools=TOOLS)
